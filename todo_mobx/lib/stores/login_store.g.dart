...
mixin _$LoginStore on _LoginStore, Store {
  ...
  String toString() {
    final string =
        'email: ${email.toString()},password: ${password.toString()},loading: ${loading.toString()},passwordVisible: ${passwordVisible.toString()},loggedIn: ${loggedIn.toString()},isPasswordValid: ${isPasswordValid.toString()},isEmailValid: ${isEmailValid.toString()},loginPressed: ${loginPressed.toString()}';
    return '{$string}';
  }
}
